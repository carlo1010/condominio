...
export class QuotationListComponent implements OnInit, OnDestroy {
  ...
  onSubmit() {
    ...
    param.count = '';
    param.startDate = this.quotationForm.value.startDate? this.quotationForm.value.startDate:'';
    param.endDate = this.quotationForm.value.endDate ?this.quotationForm.value.endDate:'';
