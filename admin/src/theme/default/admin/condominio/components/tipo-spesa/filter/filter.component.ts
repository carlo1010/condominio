...
@Component({
    selector: 'app-condominio-tipo-spesa-filter',
    templateUrl: './filter.component.html',
    styleUrls: ['./filter.component.scss']
})

export class TipoSpesaFilterComponent implements OnInit {
    ...
    constructor(public fb: FormBuilder, public sandbox: ProductSandbox , public tipospesaandBox: TipoSpesaSandbox)  {}
