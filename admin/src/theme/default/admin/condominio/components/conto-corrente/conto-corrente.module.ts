...
import { ContoCorrenteFilterComponent } from './filter/filter.component';

// Routing Module
import { ContoCorrenteRoutingModule } from './conto-corrente.routing';
...
@NgModule({
    declarations: [
        ContoCorrenteAddComponent,
        ContoCorrenteListComponent,
        ContoCorrenteFilterComponent
    ],
    imports: [
        CommonModule,
        DefaultCommonModule,
...
export class ContoCorrenteModule {
}
