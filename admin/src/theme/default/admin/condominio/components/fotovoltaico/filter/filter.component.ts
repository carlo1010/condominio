...
@Component({
    selector: 'app-condominio-fotovoltaico-filter',
    templateUrl: './filter.component.html',
    styleUrls: ['./filter.component.scss']
})

export class FotovoltaicoFilterComponent implements OnInit {
    ...
    constructor(public fb: FormBuilder, public sandbox: ProductSandbox , public fotovoltaicoandBox: FotovoltaicoSandbox)  {}
