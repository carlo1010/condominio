...
export const getSubListResponse = createSelector(
  getSettingState,
  fromSetting.getCategoryListResponse
);
export const getTempSubListResponse = createSelector(
  getSettingState,
  fromSetting.getTempCategoryListResponse
);
export const getSubListRequestLoading = createSelector(
  getSettingState,
  fromSetting.getCategoryListRequestLoading
);
export const getSubListRequestLoaded = createSelector(
  getSettingState,
  fromSetting.getCategoryListRequestLoaded
);
export const getSubListRequestFailed = createSelector(
  getSettingState,
  fromSetting.getCategoryListRequestFailed
);

export const getSubAddResponse = createSelector(
  getSettingState,
  fromSetting.getCategoryAddResponse
);
export const getSubAddRequestLoading = createSelector(
  getSettingState,
  fromSetting.getCategoryAddRequestLoading
);
export const getSubAddRequestLoaded = createSelector(
  getSettingState,
  fromSetting.getCategoryAddRequestLoaded
);
export const getSubAddRequestFailed = createSelector(
  getSettingState,
  fromSetting.getCategoryAddRequestFailed
);

export const getSubaListResponse = createSelector(
  getSettingState,
  fromSetting.getCatListResponse
);
export const getSubaListRequestLoading = createSelector(
  getSettingState,
  fromSetting.getCatListRequestLoading
);
export const getSubaListRequestLoaded = createSelector(
  getSettingState,
  fromSetting.getCatListRequestLoaded
);
export const getSubaListRequestFailed = createSelector(
  getSettingState,
  fromSetting.getCatListRequestFailed
);

export const getDeleteSubsResponse = createSelector(
  getSettingState,
  fromSetting.getDeleteCategoriesResponse
);
export const getDeleteSubsRequestLoading = createSelector(
  getSettingState,
  fromSetting.getDeleteCategoriesRequestLoading
);
export const getDeleteSubsRequestLoaded = createSelector(
  getSettingState,
  fromSetting.getDeleteCategoriesRequestLoaded
);
export const getDeleteSubsRequestFailed = createSelector(
  getSettingState,
  fromSetting.getDeleteCategoriesRequestFailed
);

export const getUpdateSubsResponse = createSelector(
  getSettingState,
  fromSetting.getUpdateCategoriesResponse
);
export const getUpdateSubsRequestLoading = createSelector(
  getSettingState,
  fromSetting.getUpdateCategoriesRequestLoading
);
export const getUpdateSubsRequestLoaded = createSelector(
  getSettingState,
  fromSetting.getUpdateCategoriesRequestLoaded
);
export const getUpdateSubsRequestFailed = createSelector(
  getSettingState,
  fromSetting.getUpdateCategoriesRequestFailed
);
