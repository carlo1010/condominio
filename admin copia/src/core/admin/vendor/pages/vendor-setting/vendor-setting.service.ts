...
export class SettingService extends Api {
   ...
   */
  public subList(params: any): Observable<any> {
    return this.http.get<any>(this.url + '/condominio/sublist', { params: params });
  }
   ...
   * @param params from CategorylistForm
   */
  public subAdd(params: any): Observable<any> {
    return this.http.post<any>(
      this.url + '/vendor-sub/create-vendor-sub',
      params
    );
  }

  public subaList(params: any): Observable<any> {
    return this.http.get<any>(
      this.url + '/vendor-sub/vendorSubList/' + params.vendorId
    );
  }
   ...
   */
  deleteSub(params): Observable<any> {
    return this.http.delete(
      this.url + '/vendor-sub/delete-vendor-sub/' + params.vendorSubId,
      params
    );
  }
   ...
   */
  updateSub(params): Observable<any> {
    return this.http.put(
      this.url + '/vendor-sub/update-vendor-sub',
      params
    );
  }
