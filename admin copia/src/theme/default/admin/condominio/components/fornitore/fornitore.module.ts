...
import { FornitoreFilterComponent } from './filter/filter.component';

// Routing Module
import { FornitoreRoutingModule } from './fornitore.routing';
...
@NgModule({
    declarations: [
        FornitoreAddComponent,
        FornitoreListComponent,
        FornitoreFilterComponent
    ],
    imports: [
        CommonModule,
        DefaultCommonModule,
