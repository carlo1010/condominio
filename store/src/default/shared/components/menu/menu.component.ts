...
export class MenuComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        // this._overlayRef.hostElement.classList.add('mega-menus');
    }
    ...
    openMegaMenu() {
        ...
        const overlay = document.getElementsByClassName(' cdk-overlay-connected-position-bounding-box');
        [].forEach.call(overlay, function (el) {
            if (el.children[0].classList.contains('mega-menu-pane')) {
                el.classList.add('mega-overlay');
            }
        });
