...
export const getProductSearch = createSelector(getState, fromList.getProductSearch);
export const getProductSearchLoading = createSelector(getState, fromList.getProductSearchLoading);
export const getProductSearchLoaded = createSelector(getState, fromList.getProductSearchLoaded);
export const getProductSearchFailed = createSelector(getState, fromList.getProductSearchFailed);
