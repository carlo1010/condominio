...
export interface ListsState extends Map<string, any> {
  ...
  getProductSearchLoading: boolean;
  getProductSearchLoaded: boolean;
  getProductSearchFailed: boolean;
...
export const listsRecord = Record({
  ...
  getProductSearch: [],
  getProductSearchLoading: false,
  getProductSearchLoaded: false,
  getProductSearchFailed: false,
});
