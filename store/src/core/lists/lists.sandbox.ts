...
/*PRODUCT SEARCH LIST*/
public getProductSearch$ = this.appState$.select(getProductSearch);
public getProductSearchLoading$ = this.appState$.select(getProductSearchLoading);
public getProductSearchLoaded$ = this.appState$.select(getProductSearchLoaded);
public getProductSearchFailed$ = this.appState$.select(getProductSearchFailed);
 ...
 /* PRODUCT SEARCH LIST*/
 public getProductsearch(params): void {
  this.appState$.dispatch(new authAction.GetProductSearchList(params));
}

public changeWishlistStatus(params): void {
  this.appState$.dispatch(
    new authAction.ChangeWishlistStatusAction(params));
}
