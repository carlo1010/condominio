...
export const ActionTypes = {
  ...
  /* PRODUCT SEARCH LIST*/
 GET_PRODUCTSEARCH_LIST: type('[productsearch] get productsearch list'),
 GET_PRODUCTSEARCH_LIST_SUCCESS: type('[productsearch] get productsearch list success'),
 GET_PRODUCTSEARCH_LIST_FAIL: type('[productsearch] get productsearch list fail'),

 CLEAR_FILTER: type('[Clear-Filter] Clear Filter'),
 CHANGE_WISHLIST_STATUS: type('[Change Wishlist Status] Change wishlist status'),
};
...
export class ClearFilter implements Action {
 ...
 /* PRODUCT SEARCH LIST*/
 export class GetProductSearchList implements Action {
  type = ActionTypes.GET_PRODUCTSEARCH_LIST;

  constructor(public payload: any) {}
}

export class GetProductSearchListSuccess implements Action {
  type = ActionTypes.GET_PRODUCTSEARCH_LIST_SUCCESS;

  constructor(public payload: any) {}
}

export class GetProductSearchListFail implements Action {
  type = ActionTypes.GET_PRODUCTSEARCH_LIST_FAIL;
...
export class ChangeWishlistStatusAction implements Action {
  type = ActionTypes.CHANGE_WISHLIST_STATUS;
  constructor(public payload: any) {}
}
