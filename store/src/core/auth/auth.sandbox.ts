...
export class AuthSandbox {
  ...
  public verification$ = this.appState$.select(verification);
  public verificationLoading$ = this.appState$.select(verificationLoading);
  public verificationLoaded$ = this.appState$.select(verificationLoaded);
  public verificationFailed$ = this.appState$.select(verificationFailed);



  /* resetPassword action status*/
  ...
  public verification(params): void {
    this.appState$.dispatch(new authAction.Verification(params));
  }

  public  resetPassword(params): void {
    this.appState$.dispatch(new authAction.ResetPassword(params));
  }
