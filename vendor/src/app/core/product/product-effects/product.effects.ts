...
export class ProductEffect {
  ...
  doInActiveProductListCount$: Observable<Action> = this.action$.pipe(
    ...
    @Effect()
    doQuestionAdd$: Observable<Action> = this.action$.pipe(
    ...
    @Effect()
    doQuestionList$: Observable<Action> = this.action$.pipe(
     ...
     @Effect()
     doQuestionDelete$: Observable<Action> = this.action$.pipe(
   ...
   @Effect()
   doQuestionStatus$: Observable<Action> = this.action$.pipe(
    ...
    @Effect()
    doAnswerAdd$: Observable<Action> = this.action$.pipe(
    ...
    @Effect()
    doAnswerList$: Observable<Action> = this.action$.pipe(
     ...
     @Effect()
     doAnswerDelete$: Observable<Action> = this.action$.pipe(
   ...
   @Effect()
   doanswerstatus$: Observable<Action> = this.action$.pipe(
  ...
  //MAKE DEFAULT
  @Effect()
  makeDefault$: Observable<Action> = this.action$.pipe(
