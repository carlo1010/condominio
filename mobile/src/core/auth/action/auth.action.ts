...
export const ActionTypes = {
  ...
  DO_SOCIAL_LOGIN: type('[Login] Do Social Login'),
  DO_SOCIAL_LOGIN_SUCCESS: type('[Login] Do Social Login Success'),
  DO_SOCIAL_LOGIN_FAIL: type('[Login] Do Social Login Fail')
};
...
// Social login
export class DoSocialLogin implements Action {
  type = ActionTypes.DO_SOCIAL_LOGIN;
  constructor(public payload: any) {}
}
export class DoSocialLoginSuccess implements Action {
  type = ActionTypes.DO_SOCIAL_LOGIN_SUCCESS;
  constructor(public payload: any) {}
}
export class DoSocialLoginFail implements Action {
  type = ActionTypes.DO_SOCIAL_LOGIN_FAIL;
  constructor(public payload: any) {}
}
